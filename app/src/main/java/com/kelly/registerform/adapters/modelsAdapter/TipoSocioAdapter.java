...
public class TipoSocioAdapter extends ArrayAdapter<TipoSocio> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<TipoSocio> list;

    public TipoSocioAdapter(Context context, int textViewResourceId,
                           List<TipoSocio> values) {
    ...
    @Override
    public TipoSocio getItem(int position){
