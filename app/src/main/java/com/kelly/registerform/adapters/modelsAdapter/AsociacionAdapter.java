...
public class AsociacionAdapter extends ArrayAdapter<Asociacion> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<Asociacion> list;

    public AsociacionAdapter(Context context, int textViewResourceId,
                           List<Asociacion> values) {
    ...
    @Override
    public Asociacion getItem(int position){
