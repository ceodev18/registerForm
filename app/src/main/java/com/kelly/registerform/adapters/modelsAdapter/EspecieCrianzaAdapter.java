...
public class EspecieCrianzaAdapter extends ArrayAdapter<EspecieCrianza> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<EspecieCrianza> list;

    public EspecieCrianzaAdapter(Context context, int textViewResourceId,
                                       List<EspecieCrianza> values) {
    ...
    @Override
    public EspecieCrianza getItem(int position){
