...
public class MedidaProduccionAdapter extends ArrayAdapter<MedidaProduccion> {
    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<MedidaProduccion> list;

    public MedidaProduccionAdapter(Context context, int textViewResourceId,
                             List<MedidaProduccion> values) {
    ...
    @Override
    public MedidaProduccion getItem(int position){
