...
/**
 * Created by KELLY on 12/02/2018.
 */

/*public class AnotherFragment {
}*/
public class AnotherFragment extends Fragment {
     ...
     * @return a new page
     */
    public static com.kelly.registerform.fragments.AnotherFragment newInstance(int color) {

        // Instantiate a new fragment
        com.kelly.registerform.fragments.AnotherFragment fragment = new com.kelly.registerform.fragments.AnotherFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_another, container, false);
