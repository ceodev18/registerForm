...
public class CertificationLiveStockActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    private String list;
    ...
    public static class DatePickerFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if(!CertificationLiveStockActivity.stateDate){
                ...
                String[] dateOwn=CertificationLiveStockActivity.dateString.split("-");
                return new DatePickerDialog(getActivity(),
                        (DatePickerDialog.OnDateSetListener)
